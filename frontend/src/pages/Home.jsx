                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20">
                                ...
                                <span className="text-red-500 font-bold tracking-[0.2em] text-[10px] uppercase">Live Feed</span>
                            </div>
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-2 tracking-tight">Available Nearby</h2>
